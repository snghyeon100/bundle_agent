...
def workspace_view(workspace, evidence_output_file):
    return {
        ...
        "file_format_notes": [
            ...
            "For bi_train.txt, the first value is bundle_id and all remaining values are item_ids in that train bundle.",
            "For ui_full.txt, the first value is user_id and all remaining values are item_ids for that user.",
